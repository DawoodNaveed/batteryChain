...
//            dd($params);
//            if (isset($params['manufacturer']) && isset($params['intermediate_screen'])) {
//                $param = parse_url($referer, PHP_URL_QUERY);
...
//                $request = $request
//                    ->duplicate(null, null, null, null, null, $serverBag->all(), null);
//                $request->query->set('manufacturer', $params['manufacturer']);
//                $request->query->set('intermediate_screen', $params['intermediate_screen']);
//                return new RedirectResponse($this->admin->generateUrl('list', [
//                    'filter' => $this->admin->getFilterParameters(),
...
//
////        dd($request);
//        return parent::listAction($request); // TODO: Change the autogenerated stub
//    }
}